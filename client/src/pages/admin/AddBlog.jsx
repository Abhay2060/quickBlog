...
const AddBlog = () => {
  ...
  return (
    <form onSubmit={onSubitHandler} className='flex-1 bg-blue-50/50 text-gray-600 h-full overflow-scroll'>
      <div className='bg-white w-full max-w-3xl p-4 md:p-10 sm:m-10 shadow rounded'>
        ...
        <div className='max-w-lg h-74 pb-16 sm:pb-10 pt-2 relative'>
          ...
          <button disabled={loading} type='button' onClick={generateConent} className='absolute
        ...
        <select onChange={e => setCategory(e.target.value)} name="category" id="" className='mt-2 px-3 py-2 border text-gray-500
        vorder-gray-300 outline-none rounded'>
          ...
          <div className='flex gap-2 mt-4'>
              ...
              cursor-pointer' onChange={e => setIsPublished(e.target.checked)} name="" id="" />
          </div>

          <button disabled={isAdding} type='submit' className='mt-8 w-40 h-10 bg-primary text-white
          rounded cursor-pointer text-sm'>{isAdding ? 'Adding...' : 'AddBlog'}</button>
