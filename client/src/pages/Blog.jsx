  ...
  return data ? (
    <div className='relative'>
      ...
      <div className='text-center mt-20 text-gray-600'>
        ...
        boeder-primary/35 bg-primary/5 fonnt-medium text-primary'>Michael Brown</p>
      </div>
      ...
      <div className='mx-5 max-w-5xl md:mx-auto my-10 mt-6'>
        ...
        <div className='max-w-3xl mx-auto'>
          ...
          max-w-lg'>
            ...
            p-2 border border-gray-300 rounded outline-none' name="" id="" />

            <textarea onChange={(e)=> setContent(e.target.value)} value={content} placeholder='Comment' className='w-full p-2 border
            border-gray-300 rounded outline-none h-48' required id=""></textarea>
        ...
        <div className='my-24 max-w-3xl mx-auto'>
          <p  className='font-semibold my-4'>Share this aricle on social media</p>
          <div className='flex'>
